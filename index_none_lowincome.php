...
<!-- Row 2 -->
	...
	<li><a href="index_none_lowincome.php" class="active">[clear scenarios]</a></li>
	</ul>
	</div>	
	...
	<span class="caret"></span></button>
	<ul class="dropdown-menu">
	<li><a href="index_none_minority.php">Disparate impact (minority)</a></li>
...
<script src="app_none_lowincome.js"></script>

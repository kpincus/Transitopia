...
<!-- Row 2 -->
	...
	<li><a href="index_remove_minority.php" class="active">Remove a route and increase parallel service</a></li>
	...
	<li><a href="index_remove_lowincome.php">Disproportionate burden (low-income)</a></li>
	</ul>
	</div>
...
<script src="app_remove_minority.js"></script>

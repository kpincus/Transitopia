...
-->	
	...
	<li><a href="#" class="active">Remove a route and increase parallel service</a></li>
...
<!--	
	...
	<li><a href="index_remove_lowincome.php">Disproportionate burden (low-income ridership)</a></li>
	</ul>
	</div>

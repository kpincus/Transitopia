...
<!-- Row 2 -->
	...
	<li><a href="index_remove_lowincome.php" class="active">Remove a route and increase parallel service</a></li>
	...
	<span class="caret"></span></button>
	<ul class="dropdown-menu">
	<li><a href="index_remove_minority.php">Disparate impact (minority)</a></li>
...
<script src="app_remove_lowincome.js"></script>

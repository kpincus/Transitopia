...
<!-- Row 2 -->
	...
	<li><a href="index_increase_lowincome.php">Increase service on high-ridership routes</a></li>
	<li><a href="index_remove_lowincome.php">Remove a route and increase parallel service</a></li>
	<li><a href="index_decrease_lowincome.php" class="active">Decrease service on low-ridership routes</a></li>
	...
	<span class="caret"></span></button>
	<ul class="dropdown-menu">
	<li><a href="index_decrease_minority.php">Disparate impact (minority)</a></li>
...
<script src="app_decrease_lowincome.js"></script>
